...
var logins = ['Mango', 'robotGoogles', 'Poly', 'Aj4x1sBozz', 'qwerty123'];

var isLoginValid = function isLoginValid(login) {
  return login.length >= 4 && login.length <= 16;
};

var isLoginUnique = function isLoginUnique(allLogins, login) {
  return !allLogins.includes(login);
};

var addLogin = function addLogin(allLogins, login) {
